...
void solve() {
  ...
  while(l<r){
      ...
      // cout<<"\n l , r , guess"<<l<<" , " << r << ", " << guess; 
      cout<< "\n sum of first n terms of gp of "<<guess<<"is"<<gps(guess, n);
      if(gps(guess, n) < gpsum){
        //this is not good.
        ///try again
        l = guess+1;
      }else{
  ...
  ull cur = min( (gps(l,n)-gpsum) ,(gpsum - gps(l , n-1)));
